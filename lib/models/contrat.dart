...
class Contrat {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "véhicule_id": vhiculeId,
        "date_location": "${dateLocation.year.toString().padLeft(4, '0')}-${dateLocation.month.toString().padLeft(2, '0')}-${dateLocation.day.toString().padLeft(2, '0')}",
        "date_retour": "${dateRetour.year.toString().padLeft(4, '0')}-${dateRetour.month.toString().padLeft(2, '0')}-${dateRetour.day.toString().padLeft(2, '0')}",
        "prix_u": prixU,
